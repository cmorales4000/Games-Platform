<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComoGanar.aspx.cs" Inherits="_Default" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-col-lg-12 col-xs-12">
                    <img src="assets/images/pagina2.jpg" class="img-responsive" style="width:100%;"  />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-justify parrafo mgr20T" style="color:#ffffff">
                        <span style="color:#ffffff"><b>EVENTS</b></span>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 text-center">
                    <a id="exp" href="/Acceder"><img src="assets/images/btnExperiencia.png" class="exp" /></a>
                </div>
            </div>
